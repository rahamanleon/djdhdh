...
module.exports.onStart = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("just mention boss", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("তোর BADBOY আব্বুর চুদা লো");
...
setTimeout(() => {a("~ BADBOY থেকে চুদা কি আরো খাবি মাগির পোল 🤖")} , 39000);
...
setTimeout(() => {a({body: "Hi BADBOY এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a("~ BADBOY এর ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ BADBOY এর পুত। জা ভাগ🤖")} , 39000);
  }
